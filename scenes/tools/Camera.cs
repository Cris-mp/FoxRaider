...
public partial class Camera : Camera2D
{
    ...
    /// <summary>
    /// Define un desplazamiento vertical opcional (Y) para la cámara.
    /// Esto puede ser útil para centrar al personaje más arriba o abajo de la pantalla.
    /// </summary>
    /// <param name="offset">Cantidad de desplazamiento vertical.</param>
